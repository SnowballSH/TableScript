...
racc_action_table = [
     ...
     6,     7,    10,     8,     4,     5,    16,     6,     7,     9,
     8,     4,     5,    15,     6,     7,    10,     8,     4,     5,
    10,     6,     7,    10,     8,    19 ]

racc_action_check = [
     0,     0,    13,     0,     0,    13,     0,    18,    18,    11,
    18,    18,    12,    18,     8,     8,    10,     8,     8,     1,
     8,     5,     5,     9,     5,     5,     3,     5,     7,     7,
    14,     7,     7,    20,     7,    14 ]

racc_action_pointer = [
    -2,    19,   nil,    22,   nil,    19,   nil,    26,    12,    23,
    14,     5,     8,    -5,    26,   nil,   nil,   nil,     5,   nil,
    29 ]
